...
export const createPoll = async (req, res) => {
    try {
        ...
        const { title, description, allowAnonymous, expiresAt, questions: pollQuestions } = req.body;
        ...
        console.log(creatorId, title, description, allowAnonymous, expiresAt);
...
export const getPollsBySlug = async (req, res) => {
    try {
